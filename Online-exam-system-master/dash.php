...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li <?php if(@$_GET['q']==1) echo'class=""'; ?>><a onclick="resultprint()">Print</a></li>
          </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
...
if($rowcount == 0){
	echo '<tr><td>'.$c++.'</td><td><a href="dash.php?q=1&f='.$title.'">'.$title.'</a></td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$sahi.'</td><td>'.$wrong.'</td><td>'.$time.'&nbsp;min</td>
	</tr>';
}
else
{
...
echo  '<div class="panel title" id="resultprint">
